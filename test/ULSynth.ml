...
let check_proof_no_hole_simple trip expected =
  let pf =
    ULSynth.ProofStrat.prove [] trip ULSynth.ProofStrat.INVS_SPECIFIED
      ULSynth.ProofStrat.SIMPLE ULSynth.ProofStrat.NONE
      ULSynth.ProofStrat.QUANTIFY_COLLECT ULSynth.ProofStrat.STMTS
  in
...
let check_proof_no_hole_simple_expr trip expected =
  let pf =
    ULSynth.ProofStrat.prove [] trip ULSynth.ProofStrat.INVS_SPECIFIED
      ULSynth.ProofStrat.SIMPLE ULSynth.ProofStrat.NONE
      ULSynth.ProofStrat.QUANTIFY_COLLECT ULSynth.ProofStrat.EXPRESSIONS_ONLY
  in
  let a = Proofrules.ProofRule.ruleApp_tostr pf in
  if not (compare a expected = 0) then (
    print_endline a;
...
(* let check_proof_no_hole_finite_vec trip expected =
     let pf =
       ULSynth.ProofStrat.prove [] trip ULSynth.ProofStrat.INVS_SPECIFIED
         ULSynth.ProofStrat.FINITE_VECTOR_STATE ULSynth.ProofStrat.NONE ULSynth.ProofStrat.QUANTIFY_COLLECT ULSynth.ProofStrat.EXPRESSIONS_ONLY
     in
     let a = Proofrules.ProofRule.ruleApp_tostr pf in
     if not (compare a expected = 0) then (
       print_endline a;
...
(* let check_proof_no_hole_vector_state trip expected =
     let pf =
       ULSynth.ProofStrat.prove [] trip ULSynth.ProofStrat.INVS_SPECIFIED
         ULSynth.ProofStrat.VECTOR_STATE ULSynth.ProofStrat.NONE ULSynth.ProofStrat.QUANTIFY_COLLECT ULSynth.ProofStrat.EXPRESSIONS_ONLY
     in
     let a = Proofrules.ProofRule.ruleApp_tostr pf in
     if not (compare a expected = 0) then (
       print_endline a;
   ...
   let check_proof_with_hole_simple trip expected_pf =
      let pf =
        ULSynth.ProofStrat.prove [] trip ULSynth.ProofStrat.HOLE_SYNTH
          ULSynth.ProofStrat.SIMPLE ULSynth.ProofStrat.NONE ULSynth.ProofStrat.QUANTIFY_COLLECT ULSynth.ProofStrat.EXPRESSIONS_ONLY
      in
  ...
  check_proof_no_hole_simple
    {
      ...
      post = eq_int_term (Int 0, ITVar ET);
    }
    "Int: -> {(0 == 0)} 0 {(0 == e_t)}\n\
  ...
  check_proof_no_hole_simple
    {
      ...
      prog = Boolean (Less (Numeric (Int 0), Numeric (Var "x")));
      post = Not (BVar BT);
    }
    "Int: -> {!(0 < x)} 0 {!(e_t < x)}\n\
     Var: -> {!(fresh1 < x)} x {!(fresh1 < e_t)}\n\
  ...
  check_proof_no_hole_simple
    {
      ...
      prog =
        Term
          (Numeric
             (ITE (Equals (Numeric (Var "x"), Numeric (Int 0)), Int 1, Var "x")));
  ...
  check_proof_no_hole_simple
    {
      ...
      prog =
        Stmt
          (ITE
             ( Equals (Numeric (Int 1), Numeric (Var "x")),
               Assign ("x", Numeric (Int 0)),
               Assign ("x", Numeric (Int 1)) ));
...
let test_stmt =
  ...
  check_proof_no_hole_simple
    {
      pre = False;
      prog = Stmt (Assign ("x", Numeric (Plus (Int 1, Int 1))));
  ...
  check_proof_no_hole_simple
    {
      ...
      prog =
        Stmt
          (Seq
             ( Assign ("x", Numeric (Plus (Int 1, Int 1))),
               Assign ("x", Numeric (Int 1)) ));
      post = eq_int_term (ITVar (T "x"), Int 1);
    }
    "Int: -> {(1 == 1)} 1 {(1 == 1)}\n\
...
let test_while =
  ...
  check_proof_no_hole_simple
    {
      pre = True;
      prog = Stmt (While (False, True, Assign ("x", Numeric (Int 1))));
      post = eq_int_term (ITVar (T "x"), Int 1);
    }
  ...
  check_proof_no_hole_simple
    {
      ...
      prog =
        Stmt
          (While
             ( Less
                 (Numeric (Var "x"), Numeric (Plus (Int 1, Plus (Int 1, Int 1)))),
               True,
               Assign ("x", Numeric (Plus (Var "x", Plus (Int 1, Int 1)))) ));
          ...
          (BNTerm
             {
               name = "B";
               expansions =
                 lazy [ True; Equals (Numeric (Int 0), Numeric (Int 0)) ];
               strongest = lazy None;
             });
      post = BVar BT;
    }
...
let test_rec_nonterm_no_hole =
  ...
  in
  check_proof_no_hole_simple_expr
    {
      pre = True;
      prog = Term (Numeric (NNTerm n));
      post = less_int_term (Int 0, ITVar ET);
    }
    "Int: -> [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] |- {(0 < 1)} 1 {(0 < e_t)}\n\
     Int: -> [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] |- {((Forall fresh2). ((T => \
     (0 < fresh2)) => (0 < (1 + fresh2))))} 1 {((Forall fresh2). ((T => (0 < \
     fresh2)) => (0 < (e_t + fresh2))))}\n\
     ApplyHP: -> [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] |- {T} [N MGF=(0 < e_t)] \
     {(0 < e_t)}\n\
     Adapt: [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] |- {T} [N MGF=(0 < e_t)] {(0 < \
     e_t)} -> [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] |- {((Forall fresh2). ((T => \
     (0 < fresh2)) => (0 < (fresh1 + fresh2))))} [N MGF=(0 < e_t)] {(0 < \
     (fresh1 + e_t))}\n\
     Plus: [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] |- {((Forall fresh2). ((T => (0 \
     < fresh2)) => (0 < (1 + fresh2))))} 1 {((Forall fresh2). ((T => (0 < \
     fresh2)) => (0 < (e_t + fresh2))))}, [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] \
     |- {((Forall fresh2). ((T => (0 < fresh2)) => (0 < (fresh1 + fresh2))))} \
     [N MGF=(0 < e_t)] {(0 < (fresh1 + e_t))} -> [{T} [N MGF=(0 < e_t)] {(0 < \
     e_t)}] |- {((Forall fresh2). ((T => (0 < fresh2)) => (0 < (1 + \
     fresh2))))} (1 + [N MGF=(0 < e_t)]) {(0 < e_t)}\n\
     HP: [{T} [N MGF=(0 < e_t)] {(0 < e_t)}] |- {(0 < 1)} 1 {(0 < e_t)}, [{T} \
     [N MGF=(0 < e_t)] {(0 < e_t)}] |- {((Forall fresh2). ((T => (0 < fresh2)) \
     => (0 < (1 + fresh2))))} (1 + [N MGF=(0 < e_t)]) {(0 < e_t)} -> {((T && \
     (0 < 1)) && ((Forall fresh2). ((T => (0 < fresh2)) => (0 < (1 + \
     fresh2)))))} [N MGF=(0 < e_t)] {(0 < e_t)}\n\
     Weaken: {((T && (0 < 1)) && ((Forall fresh2). ((T => (0 < fresh2)) => (0 \
     < (1 + fresh2)))))} [N MGF=(0 < e_t)] {(0 < e_t)} -> {T} [N MGF=(0 < \
     e_t)] {(0 < e_t)}\n\
     Adapt: {T} [N MGF=(0 < e_t)] {(0 < e_t)} -> {((Forall fresh1). ((T => (0 \
     < fresh1)) => (0 < fresh1)))} [N MGF=(0 < e_t)] {(0 < e_t)}\n\
     Weaken: {((Forall fresh1). ((T => (0 < fresh1)) => (0 < fresh1)))} [N \
     MGF=(0 < e_t)] {(0 < e_t)} -> {T} [N MGF=(0 < e_t)] {(0 < e_t)}";
  ...
  let rec b =
    {
      ...
      expansions =
        lazy
          [
            Equals (Numeric (Var "x"), Numeric (Int 1));
            Or (BNTerm b, Equals (Numeric (Var "x"), Numeric (Int 0)));
          ];
      strongest =
        lazy
          (Some
  ...
  check_proof_no_hole_simple_expr
    ...
    "Var: -> [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((x == 1) => (x == 1))} x {((x == 1) => (e_t == 1))}\n\
     Int: -> [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((x == 1) => (fresh1 == 1))} 1 {((x == 1) => (fresh1 == e_t))}\n\
     Equals: [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((x == 1) => (x == 1))} x {((x == 1) => (e_t == 1))}, [{(x == 1)} [B \
     MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- {((x == 1) => (fresh1 == \
     1))} 1 {((x == 1) => (fresh1 == e_t))} -> [{(x == 1)} [B MGF=((x == 1) => \
     b_t)] {((x == 1) => b_t)}] |- {((x == 1) => (x == 1))} (x = 1) {((x == 1) \
     => b_t)}\n\
     ApplyHP: -> [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}\n\
     Adapt: [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- {(x \
     == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)} -> [{(x == 1)} [B \
     MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- {((Forall fresh2). (((x == \
     1) => ((x == 1) => fresh2)) => ((x == 1) => (fresh2 || (x == 0)))))} [B \
     MGF=((x == 1) => b_t)] {((x == 1) => (b_t || (x == 0)))}\n\
     Var: -> [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((x == 1) => (fresh1 || (x == 0)))} x {((x == 1) => (fresh1 || (e_t == \
     0)))}\n\
     Int: -> [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((x == 1) => (fresh1 || (fresh2 == 0)))} 0 {((x == 1) => (fresh1 || \
     (fresh2 == e_t)))}\n\
     Equals: [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((x == 1) => (fresh1 || (x == 0)))} x {((x == 1) => (fresh1 || (e_t == \
     0)))}, [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- {((x \
     == 1) => (fresh1 || (fresh2 == 0)))} 0 {((x == 1) => (fresh1 || (fresh2 \
     == e_t)))} -> [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] \
     |- {((x == 1) => (fresh1 || (x == 0)))} (x = 0) {((x == 1) => (fresh1 || \
     b_t))}\n\
     Or: [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((Forall fresh2). (((x == 1) => ((x == 1) => fresh2)) => ((x == 1) => \
     (fresh2 || (x == 0)))))} [B MGF=((x == 1) => b_t)] {((x == 1) => (b_t || \
     (x == 0)))}, [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] \
     |- {((x == 1) => (fresh1 || (x == 0)))} (x = 0) {((x == 1) => (fresh1 || \
     b_t))} -> [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- \
     {((Forall fresh2). (((x == 1) => ((x == 1) => fresh2)) => ((x == 1) => \
     (fresh2 || (x == 0)))))} ([B MGF=((x == 1) => b_t)] || (x = 0)) {((x == \
     1) => b_t)}\n\
     HP: [{(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)}] |- {((x == \
     1) => (x == 1))} (x = 1) {((x == 1) => b_t)}, [{(x == 1)} [B MGF=((x == \
     1) => b_t)] {((x == 1) => b_t)}] |- {((Forall fresh2). (((x == 1) => ((x \
     == 1) => fresh2)) => ((x == 1) => (fresh2 || (x == 0)))))} ([B MGF=((x == \
     1) => b_t)] || (x = 0)) {((x == 1) => b_t)} -> {((T && ((x == 1) => (x == \
     1))) && ((Forall fresh2). (((x == 1) => ((x == 1) => fresh2)) => ((x == \
     1) => (fresh2 || (x == 0))))))} [B MGF=((x == 1) => b_t)] {((x == 1) => \
     b_t)}\n\
     Weaken: {((T && ((x == 1) => (x == 1))) && ((Forall fresh2). (((x == 1) \
     => ((x == 1) => fresh2)) => ((x == 1) => (fresh2 || (x == 0))))))} [B \
     MGF=((x == 1) => b_t)] {((x == 1) => b_t)} -> {(x == 1)} [B MGF=((x == 1) \
     => b_t)] {((x == 1) => b_t)}\n\
     Adapt: {(x == 1)} [B MGF=((x == 1) => b_t)] {((x == 1) => b_t)} -> \
     {((Forall fresh2). (((x == 1) => ((x == 1) => fresh2)) => fresh2))} [B \
     MGF=((x == 1) => b_t)] {b_t}\n\
     Weaken: {((Forall fresh2). (((x == 1) => ((x == 1) => fresh2)) => \
  ...
  and s =
    {
      ...
      expansions =
        lazy
          [
            Assign ("x", Numeric (NNTerm n));
            Seq (SNTerm s, Assign ("x", Numeric (Plus (Var "x", NNTerm n))));
          ];
      strongest =
        lazy
          (Some
              ...
              (SNTerm
                {
                  ...
                  expansions =
                    lazy
                      [
                        Assign ("x", Numeric (Int 1));
                        Seq (Assign ("x", Numeric (Int 0)), Assign ("x", Numeric (Int 1)));
                      ];
                  strongest = lazy None;
                });
          post =
...
(* let test_ITE_vector_states =
     ...
     check_proof_no_hole_vector_state
       {
         ...
         prog =
           Stmt
             (ITE
               (Equals (Numeric (Int 1), Numeric (Var "x")), Assign ("x", Numeric (Int 0)), Assign ("x", Numeric (Int 1))));
         post =
           Exists
             ( IntTermVar (T "i"),
               Exists
     ...
     let rec s =
       {
         ...
         expansions =
           lazy
             [
               ITE (Equals (Numeric (Var "y"), Numeric (NNTerm n)), Assign ("x", Numeric (NNTerm n)), SNTerm s);
               (* Assign ("x", NNTerm n); *)
             ];
         strongest =
           lazy
   ...
   let test_stmt_vector_states =
     ...
     check_proof_no_hole_vector_state
       {
         pre = False;
         prog = Stmt (Assign ("x", Numeric (Plus (Int 1, Var "x"))));
         post =
           Forall
             ( IntTermVar (T "i"),
               eq_int_term
     ...
     check_proof_no_hole_vector_state
       {
         pre = True;
         prog = Stmt (Seq (Assign ("x", Numeric (Plus (Int 1, Int 1))), Assign ("x", Numeric (Int 1))));
         post =
           Forall
             ( IntTermVar (T "i"),
               eq_int_term (AITVar (ITApp (T "x", ITVar (T "i"))), Int 1) );
