...
let check_proof_with_hole trip expected_pf expected_synth =
  ...
  let pf_str = ruleApp_tostr pf and synth_str = synth () in
  if not (compare pf_str expected_pf = 0 && compare synth_str expected_synth = 0)
  then (print_endline pf_str; print_endline synth_str)
...
let test_rec_nonterm_with_hole =
  ...
  check_proof_with_hole
    ...
    "Var: -> [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole (b_t, \
     ...
     x))}\n\
     One: -> [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))}] |- {(hole ((fresh1 == 1), x))} 1 {(hole \
     ((fresh1 == e_t), x))}\n\
     Equals: [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))}] |- {(hole ((x == 1), x))} x {(hole ((e_t == \
     1), x))}, [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))}] |- {(hole ((fresh1 == 1), x))} 1 {(hole \
     ((fresh1 == e_t), x))} -> [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} \
     [B MGF=(hole (b_t, x))] {(hole (b_t, x))}] |- {(hole ((x == 1), x))} (x = \
     1) {(hole (b_t, x))}\n\
     ApplyHP: -> [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B \
     MGF=(hole (b_t, x))] {(hole (b_t, x))}] |- {((T && (e_t == e_t_2)) && \
     (b_t <-> b_t_2))} [B MGF=(hole (b_t, x))] {(hole (b_t, x))}\n\
     Adapt: [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))}] |- {((T && (e_t == e_t_2)) && (b_t <-> \
     b_t_2))} [B MGF=(hole (b_t, x))] {(hole (b_t, x))} -> [{((T && (e_t == \
     e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole (b_t, x))] {(hole (b_t, x))}] \
     |- {((Forall fresh1). ((Forall fresh2). ((hole (fresh2, x)) => (hole \
     ((fresh2 || (x == 0)), x)))))} [B MGF=(hole (b_t, x))] {(hole ((b_t || (x \
     == 0)), x))}\n\
     Var: -> [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))}] |- {(hole ((fresh1 || (x == 0)), x))} x \
     {(hole ((fresh1 || (e_t == 0)), x))}\n\
     Zero: -> [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))}] |- {(hole ((fresh1 || (fresh2 == 0)), x))} \
     0 {(hole ((fresh1 || (fresh2 == e_t)), x))}\n\
     Equals: [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))}] |- {(hole ((fresh1 || (x == 0)), x))} x \
     {(hole ((fresh1 || (e_t == 0)), x))}, [{((T && (e_t == e_t_2)) && (b_t \
     <-> b_t_2))} [B MGF=(hole (b_t, x))] {(hole (b_t, x))}] |- {(hole \
     ((fresh1 || (fresh2 == 0)), x))} 0 {(hole ((fresh1 || (fresh2 == e_t)), \
     x))} -> [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole (b_t, \
     x))] {(hole (b_t, x))}] |- {(hole ((fresh1 || (x == 0)), x))} (x = 0) \
     {(hole ((fresh1 || b_t), x))}\n\
     Or: [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole (b_t, \
     ...
     (fresh2, x)) => (hole ((fresh2 || (x == 0)), x)))))} ([B MGF=(hole (b_t, \
     x))] || (x = 0)) {(hole (b_t, x))}\n\
     HP: [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole (b_t, \
     x))] {(hole (b_t, x))}] |- {(hole ((x == 1), x))} (x = 1) {(hole (b_t, \
     x))}, [{((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole (b_t, \
     x))] {(hole (b_t, x))}] |- {((Forall fresh1). ((Forall fresh2). ((hole \
     (fresh2, x)) => (hole ((fresh2 || (x == 0)), x)))))} ([B MGF=(hole (b_t, \
     ...
     Adapt: {((T && (e_t == e_t_2)) && (b_t <-> b_t_2))} [B MGF=(hole \
     (b_t, x))] {(hole (b_t, x))} -> {((Forall fresh1). ((Forall fresh2). \
     ((hole (fresh2, x)) => fresh2)))} [B MGF=(hole (b_t, x))] {b_t}\n\
